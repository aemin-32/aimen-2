...
import { AscensionState, UserProfile, Theme } from '../../types/types';
import { INITIAL_STATE } from './initialState';
import { DEFAULT_THEMES } from '../../data/themeData';

export const STORAGE_KEY = 'ASCENSION_V1_DATA';
export const BACKUP_KEY = 'ASCENSION_V1_DATA_AUTO_BACKUP';

export const loadState = (): AscensionState => {
    try {
...
export const saveState = (state: AscensionState) => {
    try {
