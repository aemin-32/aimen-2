        ...
        >
            ...
            >
                ...
                <div className="grid grid-cols-2 gap-4 w-full mb-8 relative z-10">
                    {/* XP Card */}
                    <div className="bg-[#FFD35B]/5 border border-[#FFD35B]/50 px-4 py-4 rounded-2xl shadow-[0_0_25px_rgba(255,211,91,0.3)] flex flex-col items-center">
                        <span className="text-[10px] text-[#FFD35B]/70 uppercase font-black tracking-widest mb-1 drop-shadow-[0_0_5px_rgba(255,211,91,0.3)]">XP GAIN</span>
                        <div className="flex items-baseline gap-1">
                            <span className="text-2xl font-black text-[#FFD35B]">{xp}</span>
                            <span className="text-xs font-bold text-[#FFD35B] bg-[#FFD35B]/10 px-1 rounded">x{multiplier}</span>
                        </div>
                    </div>
