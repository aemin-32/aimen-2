                    ...
                    <div>
                        ...
                        <div className="w-full bg-life-hard/5 rounded-2xl p-5 border border-life-hard/30 flex flex-col gap-3 relative overflow-hidden mb-8 shadow-[0_0_15px_rgba(239,68,68,0.1)]">
                             ...
                             <div className="text-sm sm:text-base text-life-text pl-9 leading-relaxed mt-1">
                                 If you miss today, your streak will fall to <span className="font-mono font-black text-life-gold bg-life-gold/10 px-2 py-0.5 rounded mx-1">{potentialFallStreak}</span>.
                             </div>
                             <div className="text-xs sm:text-sm text-life-muted/80 pl-9 mt-1">
                                 Reaching <span className="text-life-text font-bold">{levelData.nextCheckpoint}</span> will secure your next safety net.
                             </div>
                        </div>
                    </div>
